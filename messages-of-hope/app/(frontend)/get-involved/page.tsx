...
import { Hospital, Package, PackagePlus } from "lucide-react";
...
export default function GetInvolvedRoute() {
  return (
    <main className="flex flex-col gap-y-16 mb-12 relative overflow-x-hidden">
      <section className="bg-moh-dark-blue text-zinc-100">
          ...
          <div className="flex flex-col items-center gap-4 md:grid grid-cols-2 md:gap-8">
            ...
            <div className="flex flex-col justify-center items-start gap-3 row-start-1">
              ...
              <p>
                ...
                we are asking for your support. Whether you can provide a
                donation directly, send us items for Bags of Hope, or even just
                share our work and story on Instagram your support is what we
                rely on. With your help, we can be there for everyone who needs
                us.
              </p>
              <p>
                ...
                those who are struggling to cope. We are always looking for
      ...
      <section className="mx-auto max-w-7xl w-[90%] flex flex-col gap-3">
        <h2 className="font-quicksand font-bold text-3xl tracking-tight">
      ...
      <section className="flex justify-center items-stretch flex-wrap grow gap-4 mx-auto max-w-6xl w-[90%] xl:justify-between">
        <article className="flex flex-col items-center gap-2 rounded-md max-w-xs relative shadow-lg">
          <span className="flex justify-center items-center p-4 rounded-full bg-moh-dark-blue text-zinc-100 absolute -top-[1.25rem] -right-[1rem]">
            <Package className="size-8" />
          </span>

          <h3 className="text-2xl bg-moh-blue font-quicksand font-semibold w-full py-4 pl-8 pr-12 rounded-t-md tracking-tight">
            £20
          </h3>
          <h4 className="text-xl w-full pt-4 px-8 font-quicksand font-bold tracking-tight">
            The Life Saver
          </h4>
          <p className="text-muted-foreground px-8 pb-8 text-[0.9rem]">
      ...
      <section className="bg-moh-blue py-12">
        <h2 className="text-3xl font-quicksand font-bold tracking-tight w-[90%] mx-auto max-w-7xl text-center pb-4 border-b-[3px] border-zinc-900 mb-8 xl:text-left xl:pl-16">
          How to donate
        </h2>
        <div className="mx-auto max-w-7xl w-[90%] grid gap-4 xl:grid-cols-[4fr_5fr] xl:gap-6">
          ...
          <div className="grid gap-8 max-w-md mx-auto md:grid-cols-2 md:max-w-none">
            <Link
              href="https://buy.stripe.com/fZe5kzdp88s3efS001"
              target="_blank"
            ...
            >
              ...
              />
              <h3 className="font-quicksand font-bold tracking-tight w-full text-2xl">
      ...
      <section className="mx-auto max-w-7xl w-[90%] flex flex-col gap-3">
        ...
        <h2 className="font-quicksand font-bold text-3xl tracking-tight mt-4">
          Other ways to help
        </h2>
        <p>
      ...
      <section className="w-[90%] max-w-7xl mx-auto flex flex-col gap-2 text-muted-foreground text-xs">
        <p>
          ...
          &apos;Life Saver&apos; Bags of Hope, as described in <sup>1</sup>,
          with items bought in bulk and use of existing stockpile. Whilst
          donation examples are given in terms of their contribution to Bags of
          Hope, Messages of Hope retain the right to use donations in any way
          appropriate.
          <br />
