      ...
      <MaxWidthWrapper className={styles.panel}>
        <div className={styles.item}>
          ...
          <p>
            ...
            website and social media pages. Since the origin of Messages of Hope
            we have received over 1500 messages of hope from strangers who are
            looking to give hope and provide support to other struggling
            individuals.
          </p>
          <p>
            We decided that designing and illustrating a Messages of Hope
            colouring book would be the best way to share a wide variety of some
            of our favourite message submissions. If you are looking for a fun,
            relaxing, positive and creative outlet, our colouring book is for
            you! Please share with us your completed colouring pages on social
            media.
          </p>
          <p>
            You can now purchase our Message of Hope colouring book via Amazon.
          </p>
          <Button
        ...
        <div className={styles.item}>
          <h2>Cash Donation</h2>
          <p>
            Messages of Hope heavily relies on the gratuitous donations we
            receive from individuals like yourself. Any amount you are able to
            give in support of Messages of Hope is hugely appreciated.
          </p>
          <p>
            ...
            support the ongoing work within the organisation.
          </p>
          <p>
            If you like what we do and who we are and want to help, there are
            many ways you could help us out. By donating to Messages of Hope you
            would be helping us to continue our work in spreading mental health
            awareness and giving hope to those who need it.
          </p>
          <Button
            href="https://donate.stripe.com/fZedR5bh0fUv2xa144"
            target="_blank"
            className={styles.button}
            variant={{ colour: "yellow" }}
          >
            Donate Directly
          </Button>
        </div>
        <div className={styles.item}>
          ...
          <p>
            ...
            psychiatric wards and offer comfort and dignity to patients during a
            challenging time. We also list snacks and activities that can be
