...
const Page = () => {
  return (
    <>
      <Banner title="Messages of Hope 2020" image="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726418543/Speech%20at%20Connections%202024.jpg" short={true} />

      <TextPanel imageSrc="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726436903/zrsECJjlTf_tx1c9o.jpg" imageAlt="A photographer taking a photo of someone holding a whiteboard with a message of hope" contentClassName={styles.text}>
