...
export const metadata : Metadata = generateMetadata({ absolute: "Messages of Hope 2023", description: "The Messages of Hope 2023 event at Barry Island was centred around a transformative collaborative art project that saw over 200 heartfelt messages collected and countless inspiring and empowering conversations shared." }); 

const Page = () => {
  return (
    <>
      <Banner title="Messages of Hope 2023" image="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726700642/591zjjboIe_xgbsiy_rnqbhh.jpg" short={true} />

      <MaxWidthWrapper className={styles.panel}>
        <div className={styles.content}>
          <div className={styles.images}>
            <img src="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726700532/9ntrQUf34S_sophiw_1_biixot.jpg" alt="A group of people writing messages of hope on canvases at the Messages of Hope 2023 event" />
            <img src="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726694912/Messages_of_Hope_2023_1_rpedc7.jpg" alt="Painted rocks with messages written on them" />
          </div>
        ...
        <img className={styles.image} src="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726700718/64iJ879h4k_f2a9ga_1_rjm9wy.jpg" alt="Bethan Evans standing in front of the full canvases created at the Messages of Hope 2023 event in the Barry YMCA" />
      </MaxWidthWrapper>
