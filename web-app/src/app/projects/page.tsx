...
export const metadata : Metadata = generateMetadata({ title: "Projects", description: "Explore the projects created by Messages of Hope and learn how you can get involved." }); 

const Page = () => {
  return (
    <>
      <Banner title="Projects" image="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726693988/Speech_at_Connections_2024_2_kwm5ya.jpg" short={true} />
