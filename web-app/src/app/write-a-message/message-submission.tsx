  ...
  return (
    <>
      {success ? 
        <>
          ...
          <div className={styles.popup}>
            <h3>Message Sent!</h3>
            <p>Thank you for your message. Be sure to keep an eye on our Instagram for your message in a post.</p>
            <Button variant={{ colour: "blue" }} onClick={() => setSuccess(false)}>Close</Button>
          </div>
        </> : null}
      <form className={styles.form} onSubmit={onSubmit}>
        ...
        <textarea name="message" placeholder="Write your message here..." rows={10} required className={styles.textArea}/>
        <div className={styles.inner}>
          <input name="handle" placeholder="Instagram Handle (Optional)" className={styles.input} />
