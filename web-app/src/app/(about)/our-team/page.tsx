...
export const metadata : Metadata = generateMetadata({ title: "Our Team", description: "Meet the team behind Messages of Hope and find out how you can get involved." }); 

const team = [
  {
    "name": "Bethan Evans",
    "role": "Founder and Director",
    "image": "https://res.cloudinary.com/dmto5tfe5/image/upload/v1726698435/Bethan_Evans_Profile_1_ma8qkk.jpg",
  ...
  },
  {
    "name": "Jonathan Evans",
    "role": "Director",
    "image": "https://res.cloudinary.com/dmto5tfe5/image/upload/v1726698551/Jonathan_Evans_Profile_1_liza9t.jpg",
  ...
  },
  {
    ...
    "image": "https://res.cloudinary.com/dmto5tfe5/image/upload/v1726698648/Teddy_Bear_Profile_1_sf5rcj.jpg",
...
const Page = () => {
  return (
    <>
      <Banner title="Our Team" image="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726698368/Connections_2024_Hoodies_1_gt6l1z.jpg" short={true} />
