...
const Page = () => {
  return (
    <>
      <Banner title="About Messages of Hope" image="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726428478/Filming%20-%20Connections%202024.jpg" short={true} />

      <TextPanel contentClassName={styles.aboutPanel} title="What is MOH?" imageSrc="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726428657/Writing%20a%20Message%202%20-%20Connections%202024.jpg" imageAlt="A group of people writing a message on a whiteboard during the filming of Connections 2024">
      ...
      <TextPanel contentClassName={styles.aboutPanel} title="What does MOH do?" imageSrc="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726428819/Speaker%20Box%20Street%20Party%20-%20Connections%202024.jpg" imageAlt="Speaker Box Street Party dancing at the Connections 2024 event" variant={{ textPosition: "right", colour: "blue", deco: ["topLeft", "bottomRight"], corner: "topRight" }}>
