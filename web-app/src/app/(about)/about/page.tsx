...
export const metadata : Metadata = generateMetadata({ absolute: "About Messages of Hope", description: "Messages of Hope is a Community Interest Company dedicated to supporting individuals struggling with their mental health by encouraging people to write uplifting messages. These messages are transformed into stickers and Instagram posts, spreading positivity across the UK."});

const Page = () => {
  return (
    <>
      <Banner title="About Messages of Hope" image="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726697827/Filming_-_Connections_2024_1_muvkce.jpg" short={true} />

      <TextPanel contentClassName={styles.aboutPanel} title="What is MOH?" imageSrc="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726697954/Writing_a_Message_2_-_Connections_2024_1_l5cy7x.jpg" imageAlt="A group of people writing a message on a whiteboard during the filming of Connections 2024">
        ...
        <Button className={styles.button} variant={{ colour: "yellow" }}>Write a Message</Button>
      </TextPanel>

      <TextPanel contentClassName={styles.aboutPanel} title="What does MOH do?" imageSrc="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726698087/Speaker_Box_Street_Party_-_Connections_2024_1_omqcbu.jpg" imageAlt="Speaker Box Street Party dancing at the Connections 2024 event" variant={{ textPosition: "right", colour: "blue", deco: ["topLeft", "bottomRight"], corner: "topRight" }}>
        ...
        <Button className={styles.button} variant={{ colour: "blue" }}>Our Projects</Button>
      </TextPanel>
