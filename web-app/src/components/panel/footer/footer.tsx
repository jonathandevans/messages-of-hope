    ...
    <footer className={styles.footer}>
      ...
      >
        <g data-name="Layer 1">
          ...
          />
          <path
            style={{ strokeWidth: 0, fill: "var(--blue-800)" }}
            d="M266,0h908c8.83,0,16,7.17,16,16H250c0-8.83,7.17-16,16-16Z"
          />
          <path
            style={{ strokeWidth: 0, fill: "var(--yellow-400)" }}
            d="M437,0h566c8.83,0,16,7.17,16,16H421c0-8.83,7.17-16,16-16Z"
          />
        </g>
      </svg>
      ...
      <div className={styles.panel}>
        <div className={styles.nav}>
          ...
          <ul>
            ...
            <li>
              <Link href="/projects/messages-of-hope-2023">
                Messages of Hope 2023
              </Link>
            </li>
          </ul>
          <ul>
            ...
            <li>
              <Link href="/our-creator">Our Creator</Link>
            </li>
          </ul>
        </div>
        ...
        <div className={styles.buttons}>
          <Button
            ...
            variant={{ size: "md", colour: "blue" }}
          >
            Write a Message
          </Button>
          <Button
            href="/projects/connections-2024"
            variant={{ size: "md", colour: "yellow" }}
          >
            Our Latest Project
          </Button>
        </div>
      ...
      <div className={styles.panel2}>
        <div className={styles.inner}>
          <div className={styles.links}>
            ...
            <div>
              <p>
                All rights reserved © 2024 Messages of Hope. We are a registered
