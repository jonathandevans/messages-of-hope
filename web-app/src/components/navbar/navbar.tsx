...
export const Navbar = () => {
  ...
  const onProjectClick = () => {
    ...
    setDropdown(
      dropdown === Dropdown.Projects ? Dropdown.None : Dropdown.Projects
    );
  };
  ...
  const closeDropdown = (e: any) => {
    ...
    if (e.type !== "scroll") {
      ...
      if (
        e.target.className &&
        (e.target.className.split(" ").includes(styles.dropdown) ||
          e.target.className.split(" ").includes("dropdown"))
      )
        return;
    }
    ...
    <header ref={headerRef} className={styles.header}>
      <div className={styles.innerHeader}>
        <div className={styles.left}>
          <img
            fetchPriority="high"
            src="https://res.cloudinary.com/dmto5tfe5/image/upload/v1726697658/Messages_of_Hope_Logo_1_pv4sth.png"
              ...
              {dropdown !== Dropdown.About ? null : (
                <div className={styles.dropdown}>
                  <Link href="/about">
                    ...
                    <p>
                      What is Messages of Hope? What does Messages of Hope do?
                    </p>
                  </Link>
                  <Link href="/our-team">
                    <h6>
                    ...
                    <p>
                      Who are the Messages of Hope team and how can I get
                      involved?
                    </p>
                  </Link>
              ...
              {dropdown !== Dropdown.Projects ? null : (
                <div className={styles.dropdown}>
                  <Link href="/projects/connections-2024">
                    ...
                    <p>
                      Connections is a short film created by Messages of Hope
                      that explores how we can find hope by connecting with
                      others.
                    </p>
                  </Link>
                  <Link href="/projects/bags-of-hope">
                    ...
                    <p>
                      Bags of Hope is a project to give items to patients
                      arriving on psychiatric wards.
                    </p>
                  </Link>
                  <Link href="/projects">
                    <h6>
                    ...
                    <p>
                      View all of our projects and see how you can get involved.
                    </p>
                  </Link>
                </div>
              )}
